...
bool LQtThermostatState::isOn() const { return m_isOn; }
...
LQtThermostatState::_FanLevels LQtThermostatState::fanLevel() const { return m_fanLevel; }
...
double LQtThermostatState::targetTemperature() const { return m_targetTempeature; }
...
LQtThermostatState::_ThermostatFanModes LQtThermostatState::fanMode() const { return m_fanMode; }
...
// bool LQtThermostatState::operator==(const LQtThermostatState &other) const
// {
//   return m_isOn == other.m_isOn &&
//          m_fanLevel == other.m_fanLevel &&
//          m_targetTempeature == other.m_targetTempeature &&
//          m_fanMode == other.m_fanMode;
// }
